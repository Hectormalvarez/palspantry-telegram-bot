...
# --- Conversation States for Adding a Product ---
...
PRODUCT_QUANTITY = 3  # State for receiving product quantity
PRODUCT_CATEGORY = 4  # State for receiving product category
PRODUCT_CONFIRMATION = 5 # State for confirming product details
# No other states currently defined
...
async def my_products(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if not products:
        ...
        message_parts = ["Your Products:\n\n"] # Changed header and added extra newline
        ...
        full_message = "".join(message_parts).strip() # .strip() to remove trailing double newline
